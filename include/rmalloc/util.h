...
__attribute__((always_inline)) static inline uint8_t is_power_of_two(size_t size)
{
...
__attribute__((always_inline)) static inline size_t try_round_up(size_t num, size_t val)
{
    size_t mul;
